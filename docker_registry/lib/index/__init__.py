...
class Index (object):
    ...
    def __init__(self):
        ...
        signals.layer_decreased.connect(self._handle_layer_decreased)
        signals.layer_increased.connect(self._handle_layer_increased)

        signals.tag_created.connect(self._handle_tag_created)
        signals.tag_deleted.connect(self._handle_tag_deleted)
    ...
    def _handle_layer_increased(self, sender, layer):
        pass

    def _handle_layer_decreased(self, sender, layer):
        pass

    def _handle_tag_created(self, sender, namespace, imagename, tagname, value):
        pass
